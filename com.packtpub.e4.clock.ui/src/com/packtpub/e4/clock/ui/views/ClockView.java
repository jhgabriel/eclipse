...
public class ClockView extends ViewPart {
	 ...
	 */
	public static final String ID = "com.packtpub.e4.clock.ui.views.ClockView";
	...
	public void createPartControl(Composite parent) {
		...
		Object[] objs = parent.getDisplay().getDeviceData().objects;
		int c = 0;
		...
		timezones = new Combo(parent, SWT.DOWN);
		 ...
		 * "com.packtpub.e4.clock.ui.viewer"); getSite().setSelectionProvider(viewer);
